...
export function ViewDreams() {
  ...
  const sampleDreams = [
    {
      nightId: "1",
      dreamEntry: "I was flying over a city made entirely of glass. The streets sparkled under a purple sky, and everyone moved in slow motion.",
      sleepAmount: 7.5,
      date: "2025-04-06"
    },
    {
      nightId: "2",
      dreamEntry: "I was being chased by a giant rubber duck through a supermarket. Every aisle led to a different country.",
      sleepAmount: 6,
      date: "2025-03-29"
    },
    {
      nightId: "3",
      dreamEntry: "I met a talking cat who gave me a riddle to solve before I could enter a castle made of clouds.",
      sleepAmount: 8,
      date: "2025-03-15"
    },
    {
      nightId: "4",
      dreamEntry: "I was at a concert where the band used vegetables as instruments. The carrot trumpet was surprisingly good.",
      sleepAmount: 5.5,
      date: "2025-04-01"
    },
    {
      nightId: "5",
      dreamEntry: "I kept reliving the same day over and over, except each time the people around me turned into animals.",
      sleepAmount: 7,
      date: "2025-03-31"
    }
  ];
    ...
    <div class="left-padding">
      <h1>Your Dream Notebook</h1>
      {
        dreams.length === 0 ? (
          <div>
            <p>No Dreams Found</p>
            <p>Click "Create Dream" in the top right to log your first dream!</p>
          </div>
        ) : (
          dreams.map((dream) => (
